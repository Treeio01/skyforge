...
export default function LiveFeed() {
    ...
    return (
        <div className="1440:flex hidden flex-col py-[3px] max-w-[187px] h-screen">
            ...
            <div className="flex p-[3px] gap-[3px]">
                <button className="flex py-[17px] px-[22px] gap-[1px] bg-accent">
                    <span className="text-white/24 text-[13px] leading-[104%] font-sf-display">
                        Все
                    </span>
                    <svg
                        className="p-0.5"
