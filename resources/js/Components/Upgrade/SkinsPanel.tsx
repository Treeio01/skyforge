...
export default function SkinsPanel({
    ...
    return (
        <div
            className="flex flex-col overflow-hidden min-h-[180px] rounded-t-[14px] w-full max-w-[630px] bg-accent/90 relative"
            style={{ maxHeight: 'min(calc(100dvh - 452px), calc(100dvh - 32.28vw - 32px))' }}
        >
            <div
